...
class RtspYolov8Right(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('rtsp_url', os.getenv("RTSP_URL", "rtsp://admin:BayouBot@192.168.1.131:554/h264Preview_01_sub"))
        ...
        self.pub      = self.create_publisher(String,            'yolov8/Left/detections', 10)     # changed right to left TS
        self.min_pub  = self.create_publisher(Float32MultiArray, 'cam_left/minimal',       10)    # changed right to left TS
        self.fps_pub  = self.create_publisher(Float32,           'yolov8/Left/fps',        10)     # changed right to left TS
